...
Usage:
    ...
    python -m seismic_workflow.main
"""
...
STEPS = [
    Step("01", "download", "Download data", "seismic_workflow.download"),
    Step("02", "data-cleaning", "Data cleaning", "seismic_workflow.data_cleaning"),
    Step("03", "phase-picking", "Phase picking (CNN)", "seismic_workflow.phase_picking"),
    Step("04", "association", "Phase association and raw catalog building (GaMMA)", "seismic_workflow.association"),
    Step("05", "absolute-location-prep", "Data preparation for absolute location", "seismic_workflow.absolute_location_prep"),
    Step("06", "hypoellipse-check", "Absolute location (HypoEllipse Docker run)", "seismic_workflow.hypoellipse_check"),
    Step("07", "locations-filtering", "Locations filtering", "seismic_workflow.location_filtering"),
    Step("08", "relative-relocation", "Relative relocation (HypoDD input generation)", "seismic_workflow.relative_relocation"),
]

OPTIONAL_STEPS = {
    "gamma-analysis": Step("gamma-analysis", "gamma-analysis", "Analyse GaMMA output", "seismic_workflow.analysis", optional=True),
    "plot-catalog": Step("plot-catalog", "plot-catalog", "Plot catalog (PyGMT)", "seismic_workflow.plotting", optional=True),
    "threshold-analysis": Step("threshold-analysis", "threshold-analysis", "Analyse threshold results", "seismic_workflow.threshold_analysis", optional=True),
    "cc-dd-test": Step("cc-dd-test", "cc-dd-test", "Cross-correlation DD test", "seismic_workflow.cc_dd_test", optional=True),
}
...
EXAMPLES:
  ...
  python -m seismic_workflow.main --config config.yaml --only 02
"""
